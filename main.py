...
class HelpMe:
    def help(self):
        ...
        module_tips = ["1. Щоб подивитись список команд для сортування файлів, введіть у консоль '0'.","2. Щоб подивитись список команд для менеджера контактів та записів, введіть у консоль '1'."]
