...
class HelpMe:
    ...
    def help(self):
        ...
        module_names = {'1':'сортувальника файлів','2':'менеджера контактів'}
        module_tips = {'1':"\n1. Щоб подивитись список команд для сортування файлів, введіть у консоль '1'.",'2':"\n2. Щоб подивитись список команд для менеджера контактів та записів, введіть у консоль '2'."}
        general_info = "________________________\nПомічник має декілька функцій: сортування файлів у заданій директорії, менеджер контактів та записів, тут могла бути ваша реклама."
        general_info += module_tips['1'] + module_tips['2'] + "\n________________________"
        print(general_info)
        while True:
            ...
            if answer in modules:
                string = "________________________\nСписок доступних команд для" + module_names[answer] + ":\n"
